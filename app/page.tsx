  ...
  return (
    <div className="space-y-8">
          ...
          return (
            ...
            >
              ...
              <div>
                ...
                <div className="mt-0.5 text-sm text-slate-600 dark:text-slate-300">{c.blurb}</div>
              </div>
      ...
      <section className="card p-5">
        <div className="text-sm font-semibold text-slate-900 dark:text-slate-100">What’s inside</div>
